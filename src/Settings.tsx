    ...
    <div className="h-full">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-4">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              {permissionStatus === "denied" && (
                <button
                  ...
                  className="px-3 py-1.5 text-sm border border-slate-400 rounded-sm bg-slate-600 hover:bg-slate-700 active:bg-slate-800 text-white font-semibold transition-colors"
                >
                  権限を要求
                </button>
              )}
            ...
            {hasApiKey ? (
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="px-3 py-1.5 text-sm border border-slate-400 rounded-sm bg-slate-600 hover:bg-slate-700 active:bg-slate-800 text-white font-semibold transition-colors disabled:opacity-50"
                >
                  保存
                </button>
              </div>
          ...
          {/* モデル設定 */}
          <div className="p-3 border border-slate-200 rounded-sm bg-white">
            <h2 className="text-sm font-semibold text-slate-700 mb-2">モデル</h2>
            <p className="text-xs text-slate-500 mb-2">
          ...
          <button
            ...
            disabled={isSaving}
            className="w-full px-4 py-2.5 text-sm border border-slate-400 rounded-sm bg-slate-600 hover:bg-slate-700 active:bg-slate-800 text-white font-semibold transition-colors disabled:opacity-50"
          >
            設定を保存
          </button>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 border border-slate-200 rounded-sm bg-white h-full">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-sm font-semibold text-slate-700">プロンプト</h2>
              <button
                type="button"
